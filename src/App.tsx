...
const App = () => {
  ...
  useEffect(() => {
    ...
    // Send again after a short delay to catch any late renders
    const timeouts = [
  ...
  // Also post height when content changes
  useEffect(() => {
    function postHeight() {
      const height = document.documentElement.scrollHeight;
      window.parent.postMessage({ type: "objectHeight", height }, "*");
  ...
  }, [generatedLetter, selectedCategory, showAdvanced, showCategoryInfo]);
